...
@Singleton
public class SeasonBeforeLastTestdataStrategy extends AbstractTestdataStrategy {

    private static final String CODE = "seasonBeforeLast";
    ...
    public List<BulibotTestdata> data() {
        ...
        for (int i = 1; i <= Match.NUMBER_OF_MATCHDAYS_PER_SEASON; i++) {
            data.add(new BulibotTestdata(currentSeason - 2, i));
        }
